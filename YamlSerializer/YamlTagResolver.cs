...
namespace YamlSerializer
{
    ...
    {
        private readonly Dictionary<string, Type> aliasTagToType = new Dictionary<string, Type>();
        private readonly Dictionary<Type, string> aliasTypeToTag = new Dictionary<Type, string>();
